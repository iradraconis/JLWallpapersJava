...
public class JLWallpapers {
    ...
    private static void createAndShowGUI() {
        ...
        frame.add(Box.createVerticalStrut(15));  // Vertical padding
        frame.add(button1);
        frame.add(Box.createVerticalStrut(15));  // Vertical padding
        ...
        frame.add(button2);
        frame.add(Box.createVerticalStrut(10));  // Vertical padding
        ...
        frame.pack();
        frame.setSize(280, 190); // Setzt die Größe des Fensters auf 400x300 Pixel
    ...
    private static void doYourWork() {
        SwingWorker<Void, Void> worker = new SwingWorker<Void, Void>() {
            ...
            protected void process(List<Void> chunks) {
                ...
                // Dieser Code wird auf dem Event Dispatch Thread ausgeführt.
